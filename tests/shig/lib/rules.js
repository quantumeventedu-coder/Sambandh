...
const RULES = {
  ...
  'CONTENT-DEPRECATED-TIER': {
    ...
    shig: 'SHIG-0008 · C-15',
    explain: 'One canonical term per concept: the plans are Essential/Plus/Signature. "Sambandh Pro/Max", "Go Pro/Max" are deprecated synonyms.',
    fix: 'Use Sambandh Essential / Plus / Signature in member-facing copy.',
